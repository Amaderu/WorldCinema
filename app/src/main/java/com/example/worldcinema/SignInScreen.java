...
public class SignInScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Drawable shape_transparent= ResourcesCompat.getDrawable(res, R.drawable.text_borders, getTheme());
        Drawable shape_orange = ResourcesCompat.getDrawable(res, R.drawable.button_borders,getTheme());

        btnReg.setBackground(shape_transparent);
        btnLog.setBackground(shape_orange);*/
    }
